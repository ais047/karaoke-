...
var musixMatchURL = "https://api.musixmatch.com/ws/1.1/track.search?" + searchfor[0] +"=" 
+ searchQuery + "&page_size=10&page=1&s_track_rating=desc&format=JSONP&apikey=" + musixMatchKey
$.ajax({
    url: musixMatchURL,
    dataType: "JSONP",
    type: "GET"
    ...
    console.log(plswork);
    	for(var i =0; i< plswork.length; i++){
    		...
    		var container = $("<div>");	
    		container.append($("<div>").html("<img src='"+ plswork[i].track.album_coverart_100x100 +"''></img>"));
    		container.append($("<div>").html("Artist: "+ plswork[i].track.artist_name +"<br> Album Name: " + plswork[i].track.album_name + 
